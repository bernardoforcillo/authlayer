...
const (
	TeamService_CreateTeam_FullMethodName   = "/authlayer.v1.TeamService/CreateTeam"
	TeamService_GetTeam_FullMethodName      = "/authlayer.v1.TeamService/GetTeam"
	TeamService_UpdateTeam_FullMethodName   = "/authlayer.v1.TeamService/UpdateTeam"
	TeamService_DeleteTeam_FullMethodName   = "/authlayer.v1.TeamService/DeleteTeam"
	TeamService_ListTeams_FullMethodName    = "/authlayer.v1.TeamService/ListTeams"
	TeamService_AddMember_FullMethodName    = "/authlayer.v1.TeamService/AddMember"
	TeamService_RemoveMember_FullMethodName = "/authlayer.v1.TeamService/RemoveMember"
	TeamService_ListMembers_FullMethodName  = "/authlayer.v1.TeamService/ListMembers"
)
...
type TeamServiceClient interface {
	...
	AddMember(ctx context.Context, in *AddTeamMemberRequest, opts ...grpc.CallOption) (*AddTeamMemberResponse, error)
	RemoveMember(ctx context.Context, in *RemoveTeamMemberRequest, opts ...grpc.CallOption) (*RemoveTeamMemberResponse, error)
...
func (c *teamServiceClient) AddMember(ctx context.Context, in *AddTeamMemberRequest, opts ...grpc.CallOption) (*AddTeamMemberResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *teamServiceClient) RemoveMember(ctx context.Context, in *RemoveTeamMemberRequest, opts ...grpc.CallOption) (*RemoveTeamMemberResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedTeamServiceServer) AddMember(context.Context, *AddTeamMemberRequest) (*AddTeamMemberResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddMember not implemented")
}
func (UnimplementedTeamServiceServer) RemoveMember(context.Context, *RemoveTeamMemberRequest) (*RemoveTeamMemberResponse, error) {
...
var TeamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "authlayer.v1.TeamService",
	...
	Metadata: "authlayer/v1/team.proto",
}
